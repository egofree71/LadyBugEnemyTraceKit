...
--
-- If you want to load a save state automatically, edit CONFIG.save_state below.
-- The save state path can be relative to MAME's configured state directory.

local CONFIG = {
    output_prefix = "ladybug_enemy_trace", -- creates *_initial_snapshot.json and *_trace.jsonl
